...
export default class TransactionScreen extends React.Component {
    ...
    handleTransaction = async()=>{
      ...
      if(!transactionType){
        Alert.alert("the book does not exist in db")
        this.setState({
            scannedBookId:'',
           studentId:''
          })
      ...
      if(isStudentEligible){
        ...
        var isStudentEligibl = await this.checkStudentEligibilityForBookReturn();
    ...
    checkStudentEligibilityForBookReturn = async()=>{
      const transactionref = await db.collection("transcations").where("bookId","==",this.state.scannedBookId).limit().get()
      var isStudentEligible =""
  ...
  checkBookEligibility = async()=>{
    ...
    if(bookref.docs.length === 0){
      ...
      console.log(bookref.doc.length)
    }else{
